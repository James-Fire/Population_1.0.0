...
data:extend({
	{
		...
		energy_required = 1,
		ingredients = {
			{ MathData.StructuralResources[1],MathData.StructuralBase[1]+MathData.HousingSize[1]*MathData.HousingSize[1]+MathData.HousingPopRest[1]*MathData.StructuralScalar[1] },
			{ MathData.ElectricalResources[1],MathData.ElectricalBase[1]+MathData.HousingSize[1]*MathData.HousingSize[1]+MathData.HousingPopRest[1]*MathData.ElectricalScalar[1] },
			{ MathData.MechanicalResources[1],MathData.MechanicalBase[1]+MathData.HousingSize[1]*MathData.HousingSize[1]+MathData.HousingPopRest[1]*MathData.MechanicalScalar[1] },
		},
		result = "sf-house",
	...
	},
	{
		...
		energy_required = 5,
		ingredients = {
			{ MathData.StructuralResources[1],MathData.StructuralBase[2]+MathData.HousingSize[2]*MathData.HousingSize[2]+MathData.HousingPopRest[2]*MathData.StructuralScalar[2] },
			{ MathData.ElectricalResources[1],MathData.ElectricalBase[2]+MathData.HousingSize[2]*MathData.HousingSize[2]+MathData.HousingPopRest[2]*MathData.ElectricalScalar[2] },
			{ MathData.MechanicalResources[1],MathData.MechanicalBase[2]+MathData.HousingSize[1]*MathData.HousingSize[2]+MathData.HousingPopRest[2]*MathData.MechanicalScalar[2] },
		},
		result = "mf-house",
		--icon = "__Population__/graphics/crude-oil.png",
		--icon_size = 32,
	...
	},
	{
		...
		energy_required = 20,
		ingredients = {
			{ MathData.StructuralResources[1],MathData.StructuralBase[3]+MathData.HousingSize[3]*MathData.HousingSize[3]+MathData.HousingPopRest[3]*MathData.StructuralScalar[3]*0.6 },
			{ MathData.StructuralResources[2],MathData.StructuralBase[3]+MathData.HousingSize[3]*MathData.HousingSize[3]+MathData.HousingPopRest[3]*MathData.StructuralScalar[3]*0.2 },
			{ MathData.StructuralResources[3],MathData.StructuralBase[3]+MathData.HousingSize[3]*MathData.HousingSize[3]+MathData.HousingPopRest[3]*MathData.StructuralScalar[3]*0.2 },
			{ MathData.ElectricalResources[1],MathData.ElectricalBase[3]+MathData.HousingSize[3]*MathData.HousingSize[3]+MathData.HousingPopRest[3]*MathData.ElectricalScalar[3] },
			{ MathData.MechanicalResources[2],MathData.MechanicalBase[3]+MathData.HousingSize[3]*MathData.HousingSize[3]+MathData.HousingPopRest[3]*MathData.MechanicalScalar[3] },
		},
		result = "low-rise",
		--icon = "__Population__/graphics/crude-oil.png",
		--icon_size = 32,
	...
	},
	{
		...
		energy_required = 100,
		ingredients = {
			{ MathData.StructuralResources[2],MathData.StructuralBase[4]+MathData.HousingSize[4]*MathData.HousingSize[4]+MathData.HousingPopRest[4]*MathData.StructuralScalar[4]*0.2 },
			{ MathData.StructuralResources[3],MathData.StructuralBase[4]+MathData.HousingSize[4]*MathData.HousingSize[4]+MathData.HousingPopRest[4]*MathData.StructuralScalar[4]*0.8 },
			{ MathData.ElectricalResources[2],MathData.ElectricalBase[4]+MathData.HousingSize[4]*MathData.HousingSize[4]+MathData.HousingPopRest[4]*MathData.ElectricalScalar[4] },
			{ MathData.MechanicalResources[3],MathData.MechanicalBase[4]+MathData.HousingSize[4]*MathData.HousingSize[4]+MathData.HousingPopRest[4]*MathData.MechanicalScalar[4] },
		},
		result = "ap-tower",
		--icon = "__Population__/graphics/crude-oil.png",
		--icon_size = 32,
	...
	},
	{
		...
		energy_required = 500,
		ingredients = {
			{ MathData.StructuralResources[2],MathData.StructuralBase[5]+MathData.HousingSize[5]*MathData.HousingSize[5]+MathData.HousingPopRest[5]*MathData.StructuralScalar[5]*0.1 },
			{ MathData.StructuralResources[3],MathData.StructuralBase[5]+MathData.HousingSize[5]*MathData.HousingSize[5]+MathData.HousingPopRest[5]*MathData.StructuralScalar[5]*0.4 },
			{ MathData.StructuralResources[4],MathData.StructuralBase[5]+MathData.HousingSize[5]*MathData.HousingSize[5]+MathData.HousingPopRest[5]*MathData.StructuralScalar[5]*0.5 },
			{ MathData.ElectricalResources[2],MathData.ElectricalBase[5]+MathData.HousingSize[5]*MathData.HousingSize[5]+MathData.HousingPopRest[5]*MathData.ElectricalScalar[5] },
			{ MathData.MechanicalResources[3],MathData.MechanicalBase[5]+MathData.HousingSize[5]*MathData.HousingSize[5]+MathData.HousingPopRest[5]*MathData.MechanicalScalar[5] },
		},
