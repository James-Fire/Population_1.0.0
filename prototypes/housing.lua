...
data:extend({
	{
		...
		energy_required = 5,
		ingredients = {
			{ MathData.StructuralResources[1], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 1) },
	...
	},
	{
		...
		energy_required = 20,
		ingredients = {
			{ MathData.StructuralResources[1], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 2) },
			{ MathData.ElectricalResources[1], MathData.CalcStructureCost(MathData.ElectricalBase, MathData.ElectricalScalar, 2) },
			{ MathData.MechanicalResources[1], MathData.CalcStructureCost(MathData.MechanicalBase, MathData.MechanicalScalar, 2) },
		},
		result = "mf-house",
		--icon = "__Population__/graphics/crude-oil.png",
		--icon_size = 32,
	...
	},
	{
		...
		energy_required = 100,
		ingredients = {
			{ MathData.StructuralResources[1], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 3)*0.6 },
			{ MathData.StructuralResources[2], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 3)*0.2 },
			{ MathData.StructuralResources[3], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 3)*0.2 },
			{ MathData.ElectricalResources[1], MathData.CalcStructureCost(MathData.ElectricalBase, MathData.ElectricalScalar, 3) },
			{ MathData.MechanicalResources[2], MathData.CalcStructureCost(MathData.MechanicalBase, MathData.MechanicalScalar, 3) },
		},
		result = "low-rise",
		--icon = "__Population__/graphics/crude-oil.png",
		--icon_size = 32,
	...
	},
	{
		...
		energy_required = 400,
		ingredients = {
			{ MathData.StructuralResources[2], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 4)*0.4 },
			{ MathData.StructuralResources[3], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 4)*0.6 },
			{ MathData.ElectricalResources[2], MathData.CalcStructureCost(MathData.ElectricalBase, MathData.ElectricalScalar, 4) },
			{ MathData.MechanicalResources[3], MathData.CalcStructureCost(MathData.MechanicalBase, MathData.MechanicalScalar, 4) },
		},
		result = "ap-tower",
		--icon = "__Population__/graphics/crude-oil.png",
		--icon_size = 32,
	...
	},
	{
		...
		ingredients = {
			{ MathData.StructuralResources[2], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 5)*0.1 },
			{ MathData.StructuralResources[3], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 5)*0.4 },
			{ MathData.StructuralResources[4], MathData.CalcStructureCost(MathData.StructuralBase, MathData.StructuralScalar, 5)*0.5 },
			{ MathData.ElectricalResources[2], MathData.CalcStructureCost(MathData.ElectricalBase, MathData.ElectricalScalar, 5) },
			{ MathData.MechanicalResources[3], MathData.CalcStructureCost(MathData.MechanicalBase, MathData.MechanicalScalar, 5) },
		},
